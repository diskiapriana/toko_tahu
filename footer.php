	...
	<footer style="border-top: 4px solid #ff8680;  ">
		<div class="container" style="padding-bottom: 50px;">
			<div class="row">
				<div class="col-md-4">
					<h3 style="color: #ff8680"><b>TOKO TAHU KENCANA</b></h3>
					<p>Pondok Aren - Tangerang Selatan</p>
					<p><i class="glyphicon glyphicon-earphone"></i> +628123123123</p>
					<p><i class="glyphicon glyphicon-envelope"></i> tokotahukencana@gmail.com</p>
				</div>
				<div class="col-md-4">
					<h5><b>Menu</b></h5>
